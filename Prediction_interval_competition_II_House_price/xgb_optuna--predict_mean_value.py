...
def objective(trial):
    ...
    params = {'colsample_bytree': trial.suggest_float('colsample_bytree', 0.2, 0.4),
              'gamma': trial.suggest_float('gamma', 1e-3, 0.015, log=True),
              ...
              'reg_alpha': trial.suggest_float('reg_alpha', 1e-3, 1.5, log=True),
              'reg_lambda': trial.suggest_float('reg_lambda', 1e-3, 0.3, log=True)
              }
